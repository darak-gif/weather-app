...
export default function LoadingPage(){
    ...
    return <div className="bg-slate-600/80 shadow-xl/30 mt-40 lg:mt-30 h-50 lg:h-60 xl:h-70 2xl:h-80 mx-auto w-1/2 md:w-1/4 border border-slate-800/30 rounded-lg mb-20 lg:mb-42">
            ...
            <div className="flex flex-col justify-around items-center h-50 lg:h-60 xl:h-70 2xl:h-80">
                <span className="font-bold text-2xl md:text-3xl xl:text-4xl 2xl:text-5xl text-slate-900">WAIT!</span>
                <Loader className="w-6 h-6 lg:w-8 lg:h-8 xl:w-12 xl:h-12 text-indigo-950/70"/>
                ...
                <span className="font-semibold text-xl md:text-2xl xl:text-3xl 2xl:text-4xl text-slate-950/40">Page is LOADING!</span>
            </div>
